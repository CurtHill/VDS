...
void __fastcall TMainForm::AddAxes(X3D & scene){
...
void __fastcall TMainForm::DoAlign(bool display)
{
...
void __fastcall TMainForm::Aligner(TObject *Sender){
 DoAlign(true);
}

void __fastcall TMainForm::DoContain(bool display){
 // Create a line of several blocks - Aligned in X
 X3D scene;
 X3D_Text * tptr;
 X3D_Group * gptr;
...
void __fastcall TMainForm::Contain(TObject *Sender)
{ // Test containment
  DoContain(true);
}
//---------------------------------------------------------------------------
